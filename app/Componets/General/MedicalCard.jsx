...
function MedicalCard({ isopen5, setOpen }) {
    ...
    return (
        <Modal
            ...
            classNames={'h-fit'}
        >
            <ModalContent className="h-[30rem] md:h-[35rem] bg-black text-green-600 border-white">
                {(onClose) => (
                    <>
                        <ModalBody className="relative flex ">
                            <div className="self-end h-auto  center ">
                                <div className=" absolute center-col p-2 gap-4 w-1/2 h-auto right-0 top-0 text-center">
                                    ...
                                    <div className="h-auto w-full center-col gap-1">
                                        <div className="flex flex-col lg:flex-row lg:gap-1 gap-2 w-full h-auto ">
                                            <Input
                                    ...
                                    <div className="center-col">
                                        <Button className="bg-black-800 hover:bg-blue-700 text-white" onPress={() => { checkoutMedical(formData) }}>
                                            BUY
                                        </Button>
                                        <Button onPress={() => {
                                            setOpen(false)

    ...
    return (
        <div className='h-full'>
            {Object.keys(variantCount).map((item, index) => {
                console.log(Object.values(variantCount[item].value)[variantCount[item].valueCount - 1])

                useEffect(() => {
                    if ((variantCount[item].valueCount - 1 == Object.keys(variantCount[item].value).length) && Object.values(variantCount[item].value)[variantCount[item].valueCount - 1] != undefined)
                        console.log('first')
